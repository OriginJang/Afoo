//
//  OwnerManual3ViewController.swift
//  AjouAjou
//
...
class OwnerManual3ViewController: UIViewController,BEMCheckBoxDelegate {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "ownerFirstSegue"{
            guard let nextVC = segue.destination as? UpdateInformOwnerViewController else { return }
            nextVC.isFirst = true
            print("ownerFirstSegue")
        }
    }
